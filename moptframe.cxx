...
void MOptFrame::CreateDividedPad()
{
    fXleft = 0.1;
    fXright = 0.002;
    fYbottom = 0.002;
...
MOptFrame::MOptFrame(const TGWindow *p, const TGWindow *main, UInt_t w, UInt_t h)
{
...
void MOptFrame::DrawProfiles(Int_t which_side)
{
    ...
    {
        //fPad[6][1]->cd();
		fOpt->DrawProfiles(fPad[6][1], kUnsegmented);
        //fPad[7][1]->cd();
